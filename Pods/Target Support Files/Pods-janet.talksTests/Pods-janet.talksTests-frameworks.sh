...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/FirebaseCrashlytics-framework/FirebaseCrashlytics.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/FirebaseInAppMessaging-framework/FirebaseInAppMessaging.framework"
