//
//  PreviewQuestionPosterInfoCollectionViewCell.swift
//  janet.talks
//
...
class PreviewQuestionPosterInfoCollectionViewCell: UICollectionViewCell {
    //MARK: - Properties
    
    static let identifier = "PreviewQuestionPosterInfoCollectionViewCell"
    ...
    func configure(with viewModel: PreviewQuestionPosterInfoViewModel){
