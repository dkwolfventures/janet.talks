//
//  SituationOrBackgroundTableViewCell.swift
//  janet.talks
//
...
class SituationOrBackgroundTableViewCell: UITableViewCell {

    //MARK: - properties
    static let identifier = "SituationOrBackgroundTableViewCell"
    ...
    public func configure(row: Int, viewModel: SituationOrBackgroundTableViewCellViewModel){
