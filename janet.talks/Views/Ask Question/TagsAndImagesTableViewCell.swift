//
//  TagsAndImagesTableViewCell.swift
//  janet.talks
//
...
class TagsAndImagesTableViewCell: UITableViewCell {

    //MARK: - properties
    static let identifier = "TagsAndImagesTableViewCell"
    ...
    public func configure(row: Int, viewModel: TagsAndImagesTableViewCellViewModel){
