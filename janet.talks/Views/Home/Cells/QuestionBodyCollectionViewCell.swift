//
//  QuestionBodyCollectionViewCell.swift
//  janet.talks
//
...
class QuestionBodyCollectionViewCell: UICollectionViewCell {
    //MARK: - properties
    static let identifier = "QuestionBodyCollectionViewCell"
    ...
    func configure(with viewModel: PostCollectionViewCellViewModel, index: Int){
        questionBodyLabel.text = viewModel.snipet
    }
}
